...
async function getCachedGenericCupData(competitionId: number, seasonYear: number, locale: Locale) {
  'use cache';
  cacheLife('minutes');
  const [
    standings,
    ...
    <>
      <div className="mx-auto w-full max-w-[1280px] px-4 pt-px">
        ...
        <JsonLd
          graph={buildGraph(
            buildWebPage({
              url: `${BASE_URL}/${locale}/competition/${rawCountry}/${competition.slug}`,
