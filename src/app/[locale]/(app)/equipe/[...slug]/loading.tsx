  ...
  return (
    <>
      <div className="mx-auto w-full max-w-[1280px] px-4 pt-4">
        <div className="h-4 w-56 animate-pulse rounded bg-bg-surface-2" />
      </div>
      <InnerPageShell
        pageHeader={<div className="h-32 animate-pulse rounded-xl bg-bg-surface-2" />}
        ...
        center={<div className="min-h-64 animate-pulse rounded-xl bg-bg-surface-2" />}
        rightRail={
