    ...
    <div className="overflow-hidden rounded-xl border border-border-subtle bg-bg-surface">
      ...
      {hasMore && !expanded && (
        <button
          ...
          className="flex w-full items-center justify-center gap-1.5 border-t border-border-subtle py-3 text-sm font-semibold text-accent-azure transition-colors hover:bg-bg-surface-2"
        >
