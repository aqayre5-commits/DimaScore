...
/**
 * Right-rail Widget 2 — Top assists. Renders the ranked list once stats exist, otherwise a compact
 * "available once the tournament begins" placeholder. Coverage-gated by the parent (RightRail).
 */
export function TopAssistsWidget({ players, locale }: Props) {
  ...
  return (
    <div id="top-assists" className="rounded-lg border border-border-subtle bg-bg-surface">
