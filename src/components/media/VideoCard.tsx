...
export function VideoCard({ video, onClick }: VideoCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group relative w-full overflow-hidden rounded-lg bg-bg-surface text-left transition-shadow hover:shadow-md focus-visible:ring-2 focus-visible:ring-accent-azure focus-visible:outline-none"
    >
      {/* Thumbnail */}
