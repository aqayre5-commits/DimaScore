    ...
    <div ref={ref} className="space-y-1.5">
      ...
      <div className="relative">
        <input
          ...
          className="h-8 w-full rounded-md border border-border-subtle bg-bg-canvas px-3 text-sm text-text-primary outline-none focus:border-accent-gold focus:ring-1 focus:ring-accent-gold"
        />
    ...
    <div className="space-y-1.5">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="h-8 w-32 rounded-md border border-border-subtle bg-bg-canvas px-3 text-sm text-text-primary outline-none focus:border-accent-gold focus:ring-1 focus:ring-accent-gold"
        />
        <button
          type="button"
          onClick={add}
